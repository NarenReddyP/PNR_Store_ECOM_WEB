                    ...
                    <div class="col-lg-9">
                        <div class="shop-product-fillter">
                            <div class="totall-product">
                                <p> We found <strong class="text-brand">{{ $products->total() }}</strong> items for you from <strong class="text-brand" style="text-transform: uppercase;">{{ $category_name }}</strong> category!</p>
                            </div>
                                ...
                                <div class="sort-by-cover">
                                    ...
                                    <div class="sort-by-dropdown">
                                        <ul>
                                            ...
                                            <li><a class="{{ $orderBy=='Short by Newness' ? 'active': '' }}" href="#" wire:click.prevent="changeOrderBy('Short by Newness')">Short by Newness</a></li>
