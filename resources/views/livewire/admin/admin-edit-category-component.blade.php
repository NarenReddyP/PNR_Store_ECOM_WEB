                 ...
                 <div class="row">
                     ...
                     <div class="card">
                         <div class="card-header">
                            ...
                            <div class="col-md-6">
                                <a href="{{ route('admin.categories') }}" class="btn btn-success float-end">All Categpries</a>
                            </div>
                         ...
                         <div class="card-body">
                            ...
                            @if(Session::get('message'))
                              <div id="editcategoryid" class="alert alert-success" role="alert">{{ Session::get('message') }}</div>
                            @endif

                                 <form wire:submit.prevent="updateCategory" method="POST" action="" >
                                    <div class="mb-3 mt-3">
