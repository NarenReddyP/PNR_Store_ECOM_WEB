...
<link rel="shortcut icon" type="image/x-icon" href="{{ asset('assets/imgs/theme/favicon1.PNG') }}">
            ...
            <div class="container">
                <div class="header-wrap">
                    <div class="logo logo-width-1">
                        <a href="index.html"><img src="{{ asset('assets/imgs/logo/PNR_LOGO.PNG') }}" alt="logo"></a>
                    </div>
            ...
            <div class="container">
                <div class="header-wrap header-space-between position-relative">
                    ...
                    <div class="hotline d-none d-lg-block">
                        <p><i class="fi-rs-smartphone"></i><span>Toll Free</span> (+91) 0000-000-000 </p>
                    </div>
                                ...
                                <div class="cart-dropdown-wrap cart-dropdown-hm2">
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            <div class="shopping-cart-title">
                                                <h4><a href="product-details.html">Macbook Pro 2023</a></h4>
        ...
        <div class="mobile-header-wrapper-inner">
            <div class="mobile-header-top">
                <div class="mobile-header-logo">
                    <a href="index.html"><img src="assets/imgs/logo/PNR_LOGO.PNG" alt="logo"></a>
                </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="widget-about font-md mb-md-5 mb-lg-0">
                            ...
                            <p class="wow fadeIn animated">
                                <strong>Address: </strong>48-458,GaneshNagar,Chintal, Hyderabad-500054
                            </p>
                            <p class="wow fadeIn animated">
                                <strong>Phone: </strong>+91 0000-000-000
                            </p>
                            <p class="wow fadeIn animated">
                                <strong>Email: </strong>contact@narendra.in
                            </p>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <p class="float-md-left font-sm text-muted mb-0">
                        <a href="privacy-policy.html" id="privacyid">Privacy Policy</a> | <a href="terms-conditions.html" id="termsid">Terms & Conditions</a>
                    </p>
                </div>
                <div class="col-lg-6">
                    <p class="text-lg-end text-start font-sm text-muted mb-0">
                        &copy; <strong class="text-brand">Narendra Reddy</strong> 2023, All rights reserved
                    </p>
                </div>
            </div>
        </div>
...
<script>
   ...
   $(document).ready(function(){
      $("#editcategoryid").delay(4000).fadeOut("slow");
